export interface Env {
  ...
  VOYAGER_MESSAGING_CORE_ALL_CUTOVER?: string;
  VOYAGER_MESSAGING_CORE_ROOM_CUTOVER?: string;
  VOYAGER_MESSAGING_CORE_MESSAGE_CUTOVER?: string;
  VOYAGER_MESSAGING_CORE_SYNC_CUTOVER?: string;
  VOYAGER_MESSAGING_CORE_TIMEOUT_MS?: string;
  VOYAGER_MESSAGING_CORE_IDENTITY_SYNC_TTL_MS?: string;
  VOYAGER_MESSAGING_CORE_IDENTITY_SYNC_STALE_GRACE_MS?: string;
